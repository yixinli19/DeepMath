...
const translations = {
    en: {
        ...
        'pricing.familyDiscount': 'Family Discount Available: Get 30% off when you purchase 2+ accounts for any tier',
        ...
        // Footer Section
        'footer.tagline': 'Mastery Through Challenge, Accelerated by AI',
        ...
        'faq.q3.answer': 'Get 30% off when you purchase 2 or more accounts on any tier (Bronze, Silver, or Gold). Perfect for families with multiple children or homeschooling groups.',
    ...
    zh: {
        ...
        'pricing.familyDiscount': '家庭折扣可用：购买任何层级的2+账户可享受30%折扣',
        ...
        'faq.q3.answer': '购买任何层级（青铜、白银或黄金）的2个或更多账户可享受30%折扣。非常适合有多个孩子的家庭或家庭教育群体。',
